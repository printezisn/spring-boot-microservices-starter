...
public class MovieControllerTest {
     ...
     * 
     * @param resultActions
     *            The expectation result actions
     * @param id
     *            The id of the movie
     * @param parentPropertyPath
     *            The path to the parent property of the values (Optional)
     * @return The new expectation result actions
     * @throws Exception
     */
    private ResultActions expectMovieValues(final ResultActions resultActions, final UUID id,
        final Optional<String> parentPropertyPath)
        throws Exception {
     ...
     * 
     * @param parentPropertyPath
     *            The path to the parent property
     * @param propertyName
