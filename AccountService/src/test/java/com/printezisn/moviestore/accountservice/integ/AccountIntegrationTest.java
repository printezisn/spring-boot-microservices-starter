...
public class AccountIntegrationTest {
    ...
    public void test_createAccount_validationErrors() throws Exception {
        ...
        mockMvc
            .perform(post("/account/new").content(objectMapper.writeValueAsString(new AccountDto()))
                .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isBadRequest());
    }
    ...
    private AccountDto createAccount() throws Exception {
        ...
        final String responseString = mockMvc
            .perform(post("/account/new").content(content).contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andReturn()
            .getResponse()
            .getContentAsString();
